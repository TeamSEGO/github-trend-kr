...
Flipboard는 모바일 웹 앱이 갖는 성능적 한계의 이유가 DOM 때문이며, 이를 극복하기 위한 방법으 canvas를 이용하는 것을 제안하였습니다.
대부분의 modern mobile devices는 hardware-accelerated canvas를 가지고 있기 때문에 이를 이용해 보다 높은 성능의 모바일 웹 앱을 구현 할 수 있는 것입니다.
